...
# Dump of table user_account_change_log
# ------------------------------------------------------------
DROP TABLE IF EXISTS `user_account_change_log`;

CREATE TABLE `user_account_change_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int(11) NOT NULL DEFAULT '0' COMMENT '会员id',
  `target_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '类型 1:书籍',
  `pay_order_id` int(11) NOT NULL DEFAULT '0' COMMENT '支付id',
  `task_key` varchar(60) NOT NULL DEFAULT '',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='账户历史表';
