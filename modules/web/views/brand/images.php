...
StaticService::loadAppJsFile('/js/web/brand/image.js',['depends'=>app\assets\WebAsset::className()]);
?>
<div class="row">
<div class="col-lg-12">
		<div class="row m-t">
		...
		<table class="table table-bordered m-t">
            ...
            <?php foreach ($info as $value):?>
                <tr>
                    <td>
                        <img src="<?=UrlService::buildPicUrl('brand',$value['image_key'])?>" style="width: 100px;height: 100px;"/>
                    </td>
                    <td>
                        <a target="_blank" href="<?=UrlService::buildPicUrl('brand',$value['image_key'])?>">查看大图</a>
                    </td>
                    <td>
